    ...
    const projects = [
        {
            ...
            description:
                "Mobile application for package management in condominiums.",
            ...
            features: [
                ...
                "Intuitive interface for doorkeepers",
        ...
        },
        {
            title: "BrevBuy",
            description:
                "Intelligent web system for managing purchased and resold products.",
            icon: <Package size={32} />,
            image: BrevBuy,
            features: [
                "Manual or automatic product registration with AI",
                "Data extraction via purchase receipt screenshot",
                "Financial reports of profit and investment",
                "Inventory control and sales status",
            ],
            status: "Complete",
